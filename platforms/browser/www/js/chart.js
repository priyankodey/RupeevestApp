...
function asect_alloc(schemecode)
{
    $.ajax({
        type:'get',
        url: curr_ip+'/functionalities/asect_allocation_chart',
        data :{schemecode:schemecode},
        datatype:'json',
        ...
        for(var i =0;i <= asect_alloc.asect_alloc_chart.length-1;i++)
        {
            var asect_data = asect_alloc.asect_alloc_chart[i];
             sect_code.push(asect_data.rupeevest_asect);
            hold_perc.push(asect_data.holdpercentage);
            
            if(asect_data.rupeevest_asect=="Equity")
            {
                color.push("#7cb5ec");
            }
            else if(asect_data.rupeevest_asect=="Debt")
            {
                color.push("#c9e785");
            }
             else if(asect_data.rupeevest_asect=="Cash & Cash Eqv.")
            {
                color.push("#bbbbbb");
            }
            else if(asect_data.rupeevest_asect=="Others")
            {
                color.push("#83dce9");
            }
            else if(asect_data.rupeevest_asect=="Domestic MFs")
            {
                color.push("#ffc560");
            }
             else if(asect_data.rupeevest_asect=="Gold")
            {
                color.push("#ffe84d");
            }
             else if(asect_data.rupeevest_asect=="International MFs")
            {
                color.push("#ca916e");
            }
        }        
       
        asect_alloc_piechart(sect_code,hold_perc,color);
        },
